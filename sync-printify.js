  ...
  const demoProducts = [
    {
      ...
      category: 'T-Shirts',
      images: [{ src: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
    ...
    },
    {
      ...
      category: 'Hoodies',
      images: [{ src: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['S', 'M', 'L', 'XL', '2XL'],
    ...
    },
    {
      ...
      category: 'Hats & Caps',
      images: [{ src: 'https://images.unsplash.com/photo-1556306535-0f09a537f0a3?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['One Size'],
    ...
    },
    {
      ...
      category: 'Drinkware',
      images: [{ src: 'https://images.unsplash.com/photo-1577937927133-66ef06acdf18?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['15oz'],
    ...
    },
    {
      ...
      category: 'Jackets',
      images: [{ src: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['S', 'M', 'L', 'XL', '2XL'],
      colors: ['Black', 'Navy'],
      variants: [
    ...
    },
    {
      ...
      category: 'Bags',
      images: [{ src: 'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['One Size'],
      colors: ['Black', 'Red'],
      variants: [
    ...
    },
    {
      ...
      tags: ['polo', 'apparel'],
      category: 'Polos',
      images: [{ src: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['S', 'M', 'L', 'XL', '2XL'],
    ...
    },
    {
      ...
      category: 'Drinkware',
      images: [{ src: 'https://images.unsplash.com/photo-1570831739435-6601aa3fa4fb?w=600&h=600&fit=crop', variant_ids: [], is_default: true }],
      sizes: ['32oz'],
